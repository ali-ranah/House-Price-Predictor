...
navigate('/login')
  ...
  return (
    <Navbar className="mx-auto min-w-screen !bg-black px-4 py-2 lg:px-8 lg:py-4">
      <div className="container mx-auto flex flex-wrap items-center gap-[4vw] justify-between text-blue-gray-900">
        <a href='/home'>
        <img src={logo} alt="Card 1" className="w-[18vw] h-[6vh] rounded-lg md:w-[6vw] md:h-[7vh]" />
        </a>
